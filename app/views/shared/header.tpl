...
<html lang="en-US" {$head_tags}>
	<head>
        ...
        <link rel="stylesheet" href="/assets/css/bundle.min.css" media="none" onload="if(media!='all')media='all'">
        <noscript><link rel="stylesheet" href="/assets/css/bundle.min.css"></noscript>
		<link rel="stylesheet" href="/assets/css/style.css?v143" media="none" onload="if(media!='all')media='all'">
        <noscript><link rel="stylesheet" href="/assets/css/style.css?v143"></noscript>
