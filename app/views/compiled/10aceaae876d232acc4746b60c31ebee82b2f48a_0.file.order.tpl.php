<?php
/* Smarty version 3.1.29, created on 2016-03-28 22:29:25
  from "/srv/www/Dropbox/gamehedge/app/views/order.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56f9e8857f65d2_05893751',
  'file_dependency' => 
  array (
    '10aceaae876d232acc4746b60c31ebee82b2f48a' => 
    array (
      0 => '/srv/www/Dropbox/gamehedge/app/views/order.tpl',
      1 => 1459218530,
      2 => 'file',
    ),
  ),
...
function content_56f9e8857f65d2_05893751 ($_smarty_tpl) {
...
, Row <?php echo $_smarty_tpl->tpl_vars['ticket_row']->value;?>
				...
				<div class="col-md-8">
					<section id="new-customer" ng-if="existing == 0">
						...
						<h2 class="underlined big">Billing Information</h2>
						...
						<div class="checkbox"><label><input type="checkbox" id="samebilling" name="samebilling" ng-model="data.samebilling" ng-true-value="1" ng-false-value="0" ng-change="toggleSame()" /> Shipping Address is the same as Billing Address</label></div>
						<section id="shipping-address" ng-show="data.ticket_format == 'Physical' && data.samebilling == 0">
							<h2 class="underlined big" style="margin-bottom: 15px !important">Shipping Information</h2>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="sfirstname">First Name <span>*</span></label>
										<input type="text" id="sfirstname" name="sfirstname" class="form-control" ng-model="data.sfirstname" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="slastname">Last Name <span>*</span></label>
										<input type="text" id="slastname" name="slastname" class="form-control" ng-model="data.slastname" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="saddress1">Address <span>*</span></label>
								<input type="text" id="saddress1" name="saddress1" class="form-control" ng-model="data.saddress1" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0" />
							</div>
							<div class="form-group">
								<label for="saddress2" class="optional">Address Line 2</label>
								<input type="text" id="saddress2" name="saddress2" class="form-control" ng-model="data.saddress2" />
							</div>
							<div class="row">
								<div class="col-md-5">
									<div class="form-group">
										<label for="scity">City <span>*</span></label>
										<input type="text" id="scity" name="scity" class="form-control" ng-model="data.scity" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="sstate">State <span>*</span></label>
										<select id="sstate" name="sstate" class="form-control" ng-model="data.sstate" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0">
											<option value="AL">Alabama</option>
											<option value="AK">Alaska</option>
											<option value="AZ">Arizona</option>
											<option value="AR">Arkansas</option>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" id="szipcode" name="szipcode" class="form-control" ng-model="data.szipcode" ng-required="data.ticket_format == 'Physical' && data.samebilling == 0" />
									</div>
								</div>
							</div>
						</section>
