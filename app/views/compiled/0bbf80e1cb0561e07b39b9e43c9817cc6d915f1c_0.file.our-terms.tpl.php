<?php
/* Smarty version 3.1.29, created on 2016-03-23 08:07:10
  from "/srv/www/Dropbox/gamehedge/app/views/our-terms.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56f286ee48e526_48089895',
  'file_dependency' => 
  array (
    '0bbf80e1cb0561e07b39b9e43c9817cc6d915f1c' => 
    array (
      0 => '/srv/www/Dropbox/gamehedge/app/views/our-terms.tpl',
      1 => 1458179883,
      2 => 'file',
    ),
  ),
...
function content_56f286ee48e526_48089895 ($_smarty_tpl) {
...
<main>
	<div class="container">
		<section id="legal">
			...
			<p>GameHedge is a ticket marketplace. We accept orders for tickets from our customers and we then purchase those tickets on a secondary marketplace. Once we purchase the requested tickets, we will send a confirmation to the customer that they will receive their tickets.</p>
			<p><strong><u>ARE TICKETS PURCHASED ON GAMEHEDGE GUARANTEED?</u></strong></p>
			<p>Yes. Once an order is confirmed by GameHedge, we guarantee that the customer will receive authentic tickets for their event, prior to the event, or they will receive their money back. If we are unable to purchase the tickets which have been ordered by the customer, we will notify the customer that they will not receive their tickets. TICKETS ARE NOT DEEMED PURCHASED BY THE CUSTOMER UNTIL THE CUSTOMER RECEIVES AN EMAIL CONFIRMING THE PURCHASE.</p>
			<p><strong><u>WHAT IS THE GOOD GAME GUARANTEE?</u></strong></p>
			<p>All tickets purchased on GameHedge come with the Good Game Guarantee, which means that if the home team loses by the number of runs or points as specified in Section 2 below, the customer will be entitled to a refund of 50% of the GameHedge ticket price. To be entitled to receive the refund, the customer must follow the rules set forth in Section 2 of the Terms and Conditions below.</p>
			<h2>1. PURCHASING AND PRICE OF TICKETS</h2>
			<p>THE PRICE THAT YOU PAY FOR TICKETS ON GAMEHEDGE MAY BE HIGHER THAN THE FACE VALUE PRICE PRINTED ON THE TICKETS. GameHedge provides you with the service of locating tickets that may not be available through standard channels. Tickets listed on GameHedge are purchased and supplied by GameHedge, from pre-qualified, screened, professional ticket agencies as well as individual resellers of tickets. Those resellers list these tickets at prices determined by the reseller, which may be above the price printed on the face of the ticket. The market value price for a ticket is quite volatile, determined by many factors including seat location, supply and demand, date and location of event, etc.</p>
			<h2>2. GOOD GAME GUARANTEE</h2>
			<p>All tickets sold on GameHedge come with the Good Game Guarantee. For any given regular season or post season game played to completion in the 2016 MLB season for which tickets to said game were purchased through GameHedge: if (i) the home team in that game is officially declared by the MLB to be the losing team in that game by five (5) or more runs, and if (ii) the ticket purchaser has complied with the terms and conditions of this Section 2 (including, without limitation, making the claim described below, then GameHedge will refund to the ticket purchaser 50% of the ticket price (not including any fees charged by GameHedge in connection with the ticket purchase including without limitation, service fees, shipping charges or taxes), All refund claims must be verified by GameHedge before payment is made. The final ticket price is determined by GameHedge in its sole discretion. GameHedge reserves the right to charge a processing fee in connection with the refund.</p>
