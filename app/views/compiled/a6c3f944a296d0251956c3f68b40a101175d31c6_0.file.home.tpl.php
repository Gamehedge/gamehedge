...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56f20f41bb6eb5_82940083',
  'file_dependency' => 
  array (
...
function content_56f20f41bb6eb5_82940083 ($_smarty_tpl) {
...
<section id="hero">
	...
	<div id="wrapper">
		...
		<div id="content">
			<div class="container">
				<h1>Your Team. Your Tickets.<!-- <span>Your Hedge.</span>--></h1>
					...
					<form id="form-home-search" name="formSearch" method="POST" action="/search">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" id="home-query" name="query" class="form-control" placeholder="Search by Team or Stadium..." />
	...
	<div id="home-down-arrow"><img id="home-down-arrow-link" src="/assets/img/home-down-arrow.png" alt="Continue" /></div>
</section>
<main>
	<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="guarantee-item margin-divider-half">
						...
						<p>GameHedge will contact you after the game, and refund 50% of your money!</p>
					</div>
				</div>
			</div>
