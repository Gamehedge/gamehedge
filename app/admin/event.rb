...
permit_params :id, :name, :te_uid, :is_active, :te_performer_home_id, :te_performer_visit_id, :sport_id, :venue_id, :te_venue_id, :location, :occurs_at, :url, :home_performer_id, :away_performer_id, :slug, :venue_configuration_id
