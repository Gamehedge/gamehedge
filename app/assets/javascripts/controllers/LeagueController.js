		...
		apiService.getData('/api/v1/sports/'+$routeParams.leagueId)
            .then(function(response){
                ...
                if($scope.league.name == "NHL"){
                    $rootScope.title = "NHL Hockey Tickets";
                    ...
                    $rootScope.title = "NBA Basketball Tickets";
                    ...
                    $rootScope.title = "NCAAFB Football Tickets";
                    ...
                    $rootScope.title = "NFL Football Tickets";
                    ...
                    $rootScope.title = "MLB Baseball Tickets";
