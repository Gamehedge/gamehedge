class Api::V1::EventsController < ApplicationApiController
  ...
  def show
    respond_to do |format|
      format.json { render json: @event.to_json(:only => [:id, :name, :te_uid, :te_date, :url, :occurs_at, :location, :slug], :include => {:home_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:away_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:sport => {:only =>[:id, :name, :te_uid, :description, :url, :ggg]},:venue => {:only =>[:id, :te_uid, :name, :description, :url]}})}
      format.xml { render xml: @event.to_json(:only => [:id, :name, :te_uid, :te_date, :url, :occurs_at, :location, :slug], :include => {:home_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:away_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:sport => {:only =>[:id, :name, :te_uid, :description, :url, :ggg]},:venue => {:only =>[:id, :te_uid, :name, :description, :url]}})}
    end
  end
