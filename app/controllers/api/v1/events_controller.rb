class Api::V1::EventsController < ApplicationApiController
  ...
  def show
    respond_to do |format|
      format.json { render json: @event.to_json(:only => [:id, :name, :te_uid, :te_date, :url, :occurs_at, :location, :slug], :include => {:home_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:away_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:sport => {:only =>[:id, :name, :te_uid, :description, :url, :ggg]},:venue => {:only =>[:id, :te_uid, :name, :description, :url, :location]}})}
      format.xml { render xml: @event.to_json(:only => [:id, :name, :te_uid, :te_date, :url, :occurs_at, :location, :slug], :include => {:home_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:away_performer => {:only =>[:id, :name, :te_uid, :description, :url]},:sport => {:only =>[:id, :name, :te_uid, :description, :url, :ggg]},:venue => {:only =>[:id, :te_uid, :name, :description, :url, :location]}})}
    end
  end
  ...
  def data_params
    params.permit(:id, :te_uid, :te_performer_home_id, :te_performer_visit_id, :te_date, :name, :home_performer_id, :away_performer_id, :sport_id, :occurs_at, :location, :venue_id, :slug)
  end
