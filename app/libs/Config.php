		...
		$teams = array('Arizona Diamondbacks'  => array('name'     => 'Diamondbacks',
                   ...
                   'Colorado Rockies'      => array('name'     => 'Rockies',
                                                    ...
                                                    'subtext'  => '
																																	...
																																	<p>With Troy Tulowitzki gone, the Rockies are looking for a new face of the franchise and a team that will bring cheers to Coors Field. It will be a tall task to move up and compete with the likes of the Diamondbacks, Dodgers, and Giants. The rotation is filled with capable arms but no clear number 1. Chad Bettis is gunning to be the ace with Boon Logan slated as the lead closer. The infield is solid with All-Star D. LeMahieu at second and Nolan Arenado at third base. Arenado is at the heart of the lineup with a league leading 42 home runs in 2015 to go along with 130 rbi.  Arenado appears to be picking up where he left off while boasting a .605 batting average in preseason.  With shortstop Jose Reyes off field issues, the team most do their best to focus in a highly competitive division.  The Colorado Rockies must use Coors Field as an asset and leverage their home field advantage up the ladder in a highly contested National League West.</p>
                   ...
                   'Pittsburgh Pirates'    => array('name'     => 'Pirates',
                                                    ...
                                                    'subtext'  => '
																																	...
																																	<p>A perennial playoff team for the past 3 years, only one other team (the rival St. Louis Cardinals) has won more games over the same time span. The Pirates boast one of the best outfields in all the game, featuring All Star centerfielder Andrew McCutchen, Gold Glover and budding star Starling Marte, and a young and talented Gregory Polanco.  Gerrit Cole will lead the front end of the rotation with Francisco Liriano in tow. After Liriano the rest of the rotation has more questions than answers with pitcher’s Jon Niese, Ryan Vogelsong and Jeff Locke rounding out the staff.  However, the slightest hint of trouble could usher in top MLB pitching prospect RHP Tyler Glasnow by mid-season.  After that the Pirates add in the NL’s best bullpen. Clint Hurdle and the rest of the staff looked poised to make yet another run at the postseason. PNC Park will be filled with fans cheering their Bucs for another “Buctober” and beyond.</p>
                   ...
                   'San Diego Padres'      => array('name'     => 'Padres',
                                                    ...
                                                    'subtext'  => '
																																	...
																																	<p>The San Diego Padres stayed quiet this offseason stating a commitment to build through their farm system. It all starts with hiring 38 year-old Andy Green, who previously was the Arizona Diamondbacks third base coach, as their new manager. The starting rotation will consist of workhorses James Shields and Tyson Ross, along with an inconsistent Andrew Cashner and a group of lessor known youngsters. The closer and setup positions will see new faces this year after the team traded Craig Kimbrel to Boston and Jaoquin Benoit to Seattle. The shortstop has a new face as well, with the signing Alexei Ramirez from the Chicago White Sox. Yangervis Solarte will return to 3rd base while Matt Kemp roams right field and Jon Jay takes over left field with the departure of Justin Upton. With the San Diego Padres projected to finish in last place in the National League West and the team in full rebuild mode, fans can only look up from here.</p>
                   ...
                   'Washington Nationals'  => array('name'     => 'Nationals',
                                                    ...
                                                    'subtext'  => '
																																	...
																																	<p>My my my what a difference a year makes.  Exactly one year ago today the Nationals were a sure fire team to win the NL East and challenge the top teams in all the National League.  Fortunately, or unfortunately, depending on your perspective, the New York Mets have stolen all the spotlight.  Perhaps new manager Dusty Baker thinks it’s a good thing, now the Nationals can play baseball with less expectations and pressure than previous years past. Returning this season is reigning MVP Bryce Harper with a lineup bolstered by newly acquired 2nd baseman and NLDS MVP Daniel Murphy while Ryan Zimmerman fills in at the cleanup spot.  Aces Max Scherzer and Stephen Strasburg create a formidable one two punch at the top of the rotation.   That said, the Washington Nationals might surprise or not surprise many, as contenders come October.</p>
