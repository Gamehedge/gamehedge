	...
	<header class="entry-header">
		...
		if( in_array( $format, array( 'standard', 'quote', 'link' ) ) ){
			...
			<div class="entry-thumbnail margin-bottom-30">
				<a class="post-thumbnail" href="<?php the_permalink(); ?>" aria-hidden="true" data-thumb="<?php echo esc_url( wp_get_attachment_thumb_url( get_post_thumbnail_id() ) );?>">
	                <span class="wp-post-image"<?php echo !empty( $thumbnail[0] ) ? ' style="background-image:url(' . esc_attr( $thumbnail[0] ) . ')"' : '';?>></span>
	            </a>
				<?php
